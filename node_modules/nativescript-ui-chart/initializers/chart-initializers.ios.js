        ...
        if (series.labelStyle) {
            ...
            if (series.labelStyle.margin) {
                ...
                if (series instanceof CartesianSeries) {
                    if (series.horizontalAxis instanceof CategoricalAxis ||
                        (series.owner && series.owner.horizontalAxis instanceof CategoricalAxis)) {
...
export class LineSeriesValueMapper extends CategoricalSeriesValueMapper {
    getDataPointsForSeries(series) {
        ...
        if (series.verticalAxis instanceof CategoricalAxis ||
            (series.owner && series.owner.verticalAxis instanceof CategoricalAxis)) {
