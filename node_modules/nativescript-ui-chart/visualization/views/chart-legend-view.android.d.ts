...
import * as chartModule from '../../common';
export declare class RadLegendView extends legendViewCommonModule.RadLegendView {
    private _android;
    private _chart;
    private _legendItemSelectedListener;
    get android(): com.telerik.widget.primitives.legend.RadLegendView;
    updateListViewForTheme(): void;
    ...
    private getColorForCurrentTheme;
