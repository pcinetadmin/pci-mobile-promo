...
import { RadChartBase, RadCartesianChart, RadPieChart } from "../../ui-chart.common";
import * as initializersCommon from "../../initializers/chart-initializers.common";
import { CartesianAxis } from "./chart-axis.common";
import { ChartSeriesSelectionMode, ChartSeriesStackMode, ChartSeriesPaletteMode } from "../../misc/chart-public-enum";
import { PointLabelStyle } from "../parts/chart-label-style.common";
export declare class ChartSeries extends View {
    seriesName: string;
    ...
    onLoaded(): void;
    get label(): ChartSeriesLabel;
    updateLabelColorFromStyle(): void;
    private updateLabelFontFromStyle;
    private updateLabelMarginFromStyle;
    private updateLabelFillColorFromStyle;
    private updateLabelStrokeWidthFromStyle;
    private updateLabelStrokeColorFromStyle;
    ...
    onUnloaded(): void;
    static selectionModeProperty: Property<ChartSeries, ChartSeriesSelectionMode>;
    static labelStyleProperty: Property<ChartSeries, PointLabelStyle>;
    ...
    protected get initializer(): initializersCommon.ChartSeriesValueMapper;
    get owner(): RadChartBase;
    set owner(value: RadChartBase);
    ...
    protected onSelectionModeChanged(oldValue: ChartSeriesSelectionMode, newValue: ChartSeriesSelectionMode): void;
    protected onLabelStyleChanged(oldValue: PointLabelStyle, newValue: PointLabelStyle): void;
...
export declare class CartesianSeries extends ChartSeries {
    ...
    strokeColor: Color;
    private _owner;
    get owner(): RadCartesianChart;
    set owner(value: RadCartesianChart);
    eachChild(callback: (child: View) => boolean): void;
    ...
    static paletteModeProperty: Property<CartesianSeries, ChartSeriesPaletteMode>;
    static fillColorProperty: Property<CartesianSeries, Color>;
    static strokeWidthProperty: Property<CartesianSeries, number>;
    static strokeColorProperty: Property<CartesianSeries, Color>;
    ...
    protected get initializer(): initializersCommon.CartesianSeriesValueMapper;
...
export declare class CategoricalSeries extends CartesianSeries {
    ...
    static stackModeProperty: Property<CategoricalSeries, ChartSeriesStackMode>;
    private onStackModePropertyChanged;
    private onCategoryPropertyChanged;
    protected get initializer(): initializersCommon.CategoricalSeriesValueMapper;
    protected onStackModeChanged(oldValue: ChartSeriesStackMode, newValue: ChartSeriesStackMode): void;
...
export declare class BarSeries extends CategoricalSeries {
    ...
    protected get initializer(): initializersCommon.BarSeriesValueMapper;
}
...
export declare class OhlcSeries extends CategoricalSeries {
    ...
    private onLowPropertyNamePropertyChanged;
    static strokeColorsProperty: Property<OhlcSeries, Color[]>;
    private onStrokeColorsPropertyChanged;
    protected onLowPropertyNameChanged(oldValue: string, newValue: string): void;
    protected onHighPropertyNameChanged(oldValue: string, newValue: string): void;
    ...
    protected onStrokeColorsChanged(oldValue: Color[], newValue: Color[]): void;
...
export declare class PieSeries extends ChartSeries {
    ...
    strokeColors: Color[];
    private _owner;
    get owner(): RadPieChart;
    set owner(value: RadPieChart);
    protected get initializer(): initializersCommon.PieSeriesValueMapper;
    get android(): any;
    get ios(): any;
    set ios(value: any);
    ...
    static fillColorsProperty: Property<PieSeries, Color[]>;
    static strokeWidthProperty: Property<PieSeries, number>;
    static strokeColorsProperty: Property<PieSeries, Color[]>;
...
export declare class ScatterSeries extends CartesianSeries {
    ...
    protected get initializer(): initializersCommon.ScatterSeriesValueMapper;
}
export declare class ScatterBubbleSeries extends ScatterSeries {
    ...
    private onBubbleSizePropertyPropertyChanged;
    protected onBubbleSizePropertyChanged(oldValue: string, newValue: string): void;
    get initializer(): initializersCommon.ScatterBubbleSeriesValueMapper;
}
export declare class ChartSeriesLabel extends View {
    format: string;
    static formatProperty: Property<ChartSeriesLabel, string>;
}
