import { View, AddArrayFromBuilder, Property, ObservableArray, ChangedData } from "@nativescript/core";
...
export declare class RadChartBase extends View implements AddArrayFromBuilder {
    ...
    get initializer(): initializersCommon.ChartBaseValueMapper;
    updateChart(): void;
...
export declare function setupCssScope(scopedView: any, unscopedView: any): void;
