    ...
    return new Promise(function (resolve, reject) {
        try {
            ...
            if (message) {
                ...
                const isHTML = messageAsNSString.rangeOfStringOptions('<[^>]+>', 1024 /* NSStringCompareOptions.RegularExpressionSearch */).location !== NSNotFound;
            ...
            var delegate = MFMailComposeViewControllerDelegateImpl.initWithCallback(function (result, error) {
                ...
                resolve(result === 2 /* MFMailComposeResult.Sent */);
                // close the mail
