...
export class FingerprintAuth {
    ...
    available() {
        return new Promise((resolve, reject) => {
            try {
                ...
                const biometricNoHardwareErrors = [biometricConstants.BIOMETRIC_ERROR_HW_UNAVAILABLE, biometricConstants.BIOMETRIC_ERROR_NO_HARDWARE, biometricConstants.BIOMETRIC_ERROR_SECURITY_UPDATE_REQUIRED, biometricConstants.BIOMETRIC_ERROR_UNSUPPORTED, biometricConstants.BIOMETRIC_ERROR_UNKNOWN];
                ...
                else if (biometricManager.canAuthenticate() === androidx.biometric.BiometricManager.BIOMETRIC_ERROR_NONE_ENROLLED) {
    ...
    verifyFingerprint(options, pinFallback = false) {
        return new Promise((resolve, reject) => {
            try {
                ...
                const cryptoObject = new androidx.biometric.BiometricPrompt.CryptoObject(cipher);
    ...
    verifyFingerprintWithCustomFallback(options) {
    ...
    static generateSecretKey() {
        ...
        keyGenerator.init(new android.security.keystore.KeyGenParameterSpec.Builder(KEY_NAME, android.security.keystore.KeyProperties.PURPOSE_ENCRYPT | android.security.keystore.KeyProperties.PURPOSE_DECRYPT)
