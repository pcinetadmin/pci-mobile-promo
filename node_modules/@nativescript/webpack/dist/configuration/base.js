...
function default_1(config, env = index_1.env) {
    ...
    if (env.sourceMap === 'hidden-source-map') {
        const sourceMapAbsolutePath = (0, project_1.getProjectFilePath)(`./platforms/${platform}-sourceMaps/[file].map[query]`);
    ...
    config.module
        ...
        .use('ts-loader')
        .loader('ts-loader')
        .options(Object.assign(Object.assign({}, configFile), { transpileOnly: true, allowTsInNodeModules: true, compilerOptions: {
            sourceMap: true,
            declaration: false,
