...
export declare function isBold(fontWeight: FontWeightType): boolean;
...
export declare const textShadowProperty: CssProperty<Style, string | ShadowCSSValues>;
export declare const textStrokeProperty: CssProperty<Style, string | StrokeCSSValues>;
export declare const whiteSpaceProperty: CssProperty<Style, CoreTypes.WhiteSpaceType>;
export declare const textOverflowProperty: CssProperty<Style, CoreTypes.TextOverflowType>;
