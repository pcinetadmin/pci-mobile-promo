 ...
 * @returns [string] - a value from @nativescript/core/ui/enums/DeviceOrientation
 */
export function getOrientation(sensors?: boolean): string;

/**
 * Returns true if the Orientation is locked, use .enableRotation to re-enable rotation
 */
export function getRotationLocked(): boolean;
